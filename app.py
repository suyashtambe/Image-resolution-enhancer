...
set_background(r'C:\Users\Suyash Tambe\Desktop\Fipl project\Computer+Chip+Of+Central+Processing+Unit+Network+Technology+4k+590x.jpg')
...
if input_image is not None:
    ...
    enhanced_image = ImageEnhance.Contrast(input_pil_image).enhance(4.0)  # Increase contrast
